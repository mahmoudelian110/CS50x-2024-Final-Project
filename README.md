...
YouTube link: https://youtu.be/J79epi_BTIQ
> [!IMPORTANT]
...
**User input and behavior should never be trusted**. This code pattern is present across all routes (except [`logout`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/app.py#L523)) and is intended to safeguard the system against malicious user inputs, specifically SQL injection attacks and incorrect/incomplete filling of HTML forms. This is achieved by incorporating placeholders in SQL queries and implementing server-side validation.

The SQL queries are executed by a function called [`query_db`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L48) that allows the use of placeholders for queries. The implementation details can be found at [Flask’s website](https://flask.palletsprojects.com/en/2.3.x/patterns/sqlite3/#:~:text=def%20query_db(query%2C%20args%3D()%2C%20one%3DFalse)%3A).

Regarding the HTML forms, every route that is accessed via `POST` begins with a sequence of “if statements” that assess whether the forms have been submitted and whether the provided values are valid. One particular validation used at the [`register`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/app.py#L123) route is done by a function called [`valid_password`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L83). A password and master password are only deemed valid by this function if they contain at least twelve characters, one uppercase letter, one lowercase letter, one number and one special character.

Another specific validation run by the program is done at the [`import_file`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/app.py#L418) route. In this context, the system must verify whether the file selected by the user is in the right format (CSV files only). The function [`allowed_extension`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L73) manages this process, and further implementation details can be found at [Flask’s website]( https://flask.palletsprojects.com/en/2.3.x/patterns/fileuploads/#:~:text=def%20allowed_file(filename)%3A).
...
Here is the list:
- [`get_db`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L10): Establishes a connection with the SQLite3 database
- [`make_dicts`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L39): Dictionary factory, returns rows in the database as dictionaries
- [`query_db`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L48): Allows for easy and safe execution of commands in the database
- [`login_required`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L59): Decorates the routes so they can only be accessed when the user is logged in
- [`allowed_extensions`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L73): Checks if the file extension is allowed
- [`valid_password`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/helpers.py#L83): Defines a set of rules a password must follow to be considered valid
...
Here’s the list:
- [`generate_hash`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/security.py#L20)
- [`check_password`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/security.py#L25)
- [`check_rehash`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/security.py#L34)
- [`derive_key`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/security.py#L41)
- [`encrypt`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/security.py#L60)
- [`decrypt`](https://github.com/mahmoudelian110/CS50x-2024-Final-Project/blob/main/security.py#L67)
...
## Sources
- [CS50X](https://cs50.harvard.edu/x/2024/) course materials
